...
export default function AdminPainel() {
  ...
  // =========================================================================
  // MIGRAÇÃO BLINDADA (Lógica Corrigida para a Caixa Azul)
  // =========================================================================
    ...
    try {
      ...
      snapAtivV1.docs.forEach((docAtiv) => {
        ...
        if (idNovo) {
          ...
          // CORREÇÃO AQUI: Verifica se a V1 marcou como postado, finalizado ou enviado.
          const jaFoiPostado = d.postado === true || d.status === 'finalizado' || d.status === 'postado' || d.enviado === true;
          ...
          batch.set(novaAtivRef, {
            ...
            status: temFeedback ? 'aprovado' : (d.status || 'pendente'),
            postado: jaFoiPostado, // Agora respeita o status real da V1
