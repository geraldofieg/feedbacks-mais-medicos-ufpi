...
export default function Signup() {
  ...
  const [success, setSuccess] = useState(false); // Controla a tela de "Verifique seu e-mail"
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Chama a nossa função turbinada do AuthContext
      await signup(email, password, nome, whatsapp);
      
      // Se deu certo, muda a tela para a mensagem de sucesso
      setSuccess(true);
  ...
  // TELA DE SUCESSO (Renderizada após o cadastro)
  if (success) {
    return (
