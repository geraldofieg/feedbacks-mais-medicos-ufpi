  ...
  useEffect(() => {
    const unsub = onSnapshot(collection(db, 'atividades'), (snap) => {
      ...
      setStats({
        ...
        postar: docs.filter(d => d.status === 'aprovado' && !d.postado).length, // Aprovado mas falta o Geraldo colar
        finalizados: docs.filter(d => d.status === 'aprovado' && d.postado === true).length // 100% concluído
      });
    });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto p-4 md:p-8">
        {/* As 3 Caixas do Funil */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          
          {/* Caixa 1: Tarefa da Patrícia */}
          ...
          {/* Caixa 2: Tarefa do Geraldo (NOVA) */}
