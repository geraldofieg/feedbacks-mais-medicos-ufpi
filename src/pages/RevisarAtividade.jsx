          ...
          <div className="lg:col-span-1 space-y-4">
            {isPendente ? (
              <div className="bg-blue-600 p-6 rounded-2xl shadow-md text-white animate-in fade-in duration-300 flex flex-col h-full">
                <h3 className="text-lg font-black mb-4 flex items-center gap-2 border-b border-blue-500 pb-2"><CheckCircle size={20} />3. Avaliação e Feedback</h3>
                <textarea rows="8" placeholder="Cole o feedback gerado ou digite manualmente (Opcional)..." className="w-full flex-1 min-h-[150px] p-4 rounded-xl text-gray-800 font-medium mb-4 shadow-inner outline-none focus:ring-4 focus:ring-blue-300" value={feedbackEditado} onChange={(e) => setFeedbackEditado(e.target.value)}></textarea>
              ...
              <div className="bg-gray-800 p-6 rounded-2xl shadow-md text-white animate-in fade-in duration-300">
                ...
                <div className="bg-white text-gray-800 p-4 rounded-xl text-sm mb-4 min-h-[150px] whitespace-pre-wrap font-medium shadow-inner">{atividadeAtual.feedbackFinal || atividadeAtual.feedbackSugerido || <span className="italic text-gray-400">Nenhum feedback registrado.</span>}</div>
                {(atividadeAtual.feedbackFinal || atividadeAtual.feedbackSugerido) && (
