  ...
  const gerarMensagemGeral = () => {
    ...
    if (tarefaAtivaId === 'todas') {
      ...
      if (minDiasGeral !== null) {
          ...
          if (minDiasGeral === 0) return `Olá, colegas!\n🚨 Atenção: a entrega mais próxima vence HOJE e ainda temos pendências na turma.\n\nPeço a regularização imediata para evitarmos problemas.`;
          if (minDiasGeral === 1) return `Olá, colegas!\n🚨 Passando para alertar que a entrega mais próxima vence AMANHÃ e ainda temos pendências.\n\nPeço a regularização o quanto antes para evitarmos problemas.`;
    ...
    if (diasRestantesVisual !== null) {
      ...
      if (diasRestantesVisual === 0) return `Olá, colegas!\n🚨 Atenção: o prazo de *${nomeTarefa}* encerra HOJE!\n\nPeço a regularização imediata das tarefas pendentes para evitarmos problemas.`;
      if (diasRestantesVisual === 1) return `Olá, colegas!\n🚨 Passando para alertar que o prazo de *${nomeTarefa}* encerra AMANHÃ!\n\nPeço a regularização das tarefas pendentes o quanto antes para evitarmos problemas.`;
  ...
  const gerarMensagemIndividual = (aluno) => {
    ...
    if (tarefaAtivaId === 'todas') {
        ...
        if (dias !== null && dias !== undefined) {
            ...
            if (dias === 0) return `Olá, ${primeiroNome}! Tudo bem?\n🚨 Atenção: a entrega mais próxima das suas pendências vence HOJE!\n\n${listaFormatada}\n\nPor favor, regularize ainda hoje para não termos problemas. Qualquer coisa, me chame.`;
            if (dias === 1) return `Olá, ${primeiroNome}! Tudo bem?\n🚨 Passando para alertar que a entrega mais próxima das suas pendências vence AMANHÃ!\n\n${listaFormatada}\n\nRecomendo que regularize o quanto antes para não acumular nem termos problemas. Qualquer coisa, me chame.`;
