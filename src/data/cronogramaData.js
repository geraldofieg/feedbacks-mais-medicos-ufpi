...
export const cronogramaAssincrono = [
  { 
    id: 1, eixo: "Eixo 1 - Princípios do SUS", modulo: "Módulo 1 - Políticas públicas", inicio: "2025-09-28", fim: "2025-10-11", 
    tituloCompleto: "Eixo 1 - Princípios e Fundamentos do SUS e da Atenção Primária à Saúde\nMódulo 1 - Políticas públicas de saúde: processo histórico e a organização do SUS", 
    ch: 15, creditos: 1, semanas: 2, dias: 14 
  },
  { 
    id: 2, eixo: "Eixo 1 - Princípios do SUS", modulo: "Módulo 2 - Atenção Primária e ESF", inicio: "2025-10-13", fim: "2025-10-26", 
    tituloCompleto: "Eixo 1 - Princípios e Fundamentos do SUS e da Atenção Primária à Saúde\nMódulo 2 - Atenção Primária à Saúde e Estratégia Saúde da Família: bases históricas, políticas e organizacionais", 
    ch: 15, creditos: 1, semanas: 2, dias: 14 
  },
  { 
    id: 3, eixo: "Eixo 1 - Princípios do SUS", modulo: "Módulo 3 - Princípios da MFC", inicio: "2025-10-27", fim: "2025-11-09", 
    tituloCompleto: "Eixo 1 - Princípios e Fundamentos do SUS e da Atenção Primária à Saúde\nMódulo 3 - Princípios da Medicina de Família e Comunidade", 
    ch: 15, creditos: 1, semanas: 2, dias: 14 
  },
  { 
    id: 4, eixo: "Eixo 2 - Ferramentas MFC", modulo: "Módulo 4 - Abordagem clínica", inicio: "2025-11-10", fim: "2025-12-07", 
    tituloCompleto: "Eixo 2 - Ferramentas da Medicina de Família e Comunidade\nMódulo 4 - Ferramentas de abordagem clínica", 
    ch: 30, creditos: 2, semanas: 4, dias: 28 
  },
  { 
    id: 5, eixo: "Eixo 2 - Ferramentas MFC", modulo: "Módulo 5 - Gestão da clínica", inicio: "2025-12-08", fim: "2026-01-04", 
    tituloCompleto: "Eixo 2 - Ferramentas da Medicina de Família e Comunidade\nMódulo 5 - Gestão da clínica e coordenação do cuidado", 
    ch: 30, creditos: 2, semanas: 4, dias: 28 
  },
  { 
    id: 6, eixo: "Eixo 2 - Ferramentas MFC", modulo: "Módulo 6 - Abordagem familiar", inicio: "2026-01-05", fim: "2026-02-01", 
    tituloCompleto: "Eixo 2 - Ferramentas da Medicina de Família e Comunidade\nMódulo 6 - Abordagem familiar", 
    ch: 30, creditos: 2, semanas: 4, dias: 28 
  },
  { 
    id: 7, eixo: "Eixo 2 - Ferramentas MFC", modulo: "Módulo 7 - Abordagem comunitária", inicio: "2026-02-02", fim: "2026-03-01", 
    tituloCompleto: "Eixo 2 - Ferramentas da Medicina de Família e Comunidade\nMódulo 7 - Abordagem comunitária", 
    ch: 30, creditos: 2, semanas: 4, dias: 28 
  },
  { 
    id: 8, eixo: "Eixo 3 - Grupos Específicos", modulo: "Módulo 8 - Criança e adolescente", inicio: "2026-03-02", fim: "2026-03-29", 
    tituloCompleto: "Eixo 3 - Cuidado a grupos populacionais específicos e situações especiais\nMódulo 8 - Saúde da criança e do adolescente", 
    ch: 30, creditos: 2, semanas: 4, dias: 28 
  },
  { 
    id: 9, eixo: "Atividade Acadêmica", modulo: "Semana de retenção e correção", inicio: "2026-03-30", fim: "2026-04-12", 
    tituloCompleto: "Atividades acadêmicas\nSemana de retenção para atividades pendentes e/ou notas insuficientes", 
    ch: "-", creditos: "-", semanas: 2, dias: 14 
  },
  { 
    id: 10, eixo: "Eixo 3 - Grupos Específicos", modulo: "Módulo 9 - Saúde da mulher", inicio: "2026-03-30", fim: "2026-04-26", 
    tituloCompleto: "Eixo 3 - Cuidado a grupos populacionais específicos e situações especiais\nMódulo 9 - Saúde da mulher", 
    ch: 30, creditos: 2, semanas: 4, dias: 28 
  },
  { 
    id: 11, eixo: "Eixo 3 - Grupos Específicos", modulo: "Módulo 10 - Saúde do homem", inicio: "2026-04-27", fim: "2026-05-10", 
    tituloCompleto: "Eixo 3 - Cuidado a grupos populacionais específicos e situações especiais\nMódulo 10 - Saúde do homem", 
    ch: 15, creditos: 1, semanas: 2, dias: 14 
  },
  { 
    id: 12, eixo: "Eixo 3 - Grupos Específicos", modulo: "Módulo 11 - Saúde do idoso", inicio: "2026-05-11", fim: "2026-05-24", 
    tituloCompleto: "Eixo 3 - Cuidado a grupos populacionais específicos e situações especiais\nMódulo 11 - Saúde do idoso", 
    ch: 15, creditos: 1, semanas: 2, dias: 14 
  }
];
...
export const cronogramaSincrono = [
  { 
    ...
    tema1: "Atividade prática - Descobrindo quem é o paciente", 
    tema2: "Reunião de equipe (Território e DSS)",
